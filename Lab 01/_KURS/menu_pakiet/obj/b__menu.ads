...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_menu" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#64773773#;
   pragma Export (C, u00001, "menuB");
   ...
   u00105 : constant Version_32 := 16#f9576a72#;
   pragma Export (C, u00105, "ada__tagsB");
   u00106 : constant Version_32 := 16#b6661f55#;
